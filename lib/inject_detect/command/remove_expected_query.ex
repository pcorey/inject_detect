defmodule InjectDetect.Command.RemoveExpectedQuery do
  defstruct application_id: nil,
            query_id: nil
end

defimpl InjectDetect.Command,
   for: InjectDetect.Command.RemoveExpectedQuery do

  alias InjectDetect.Event.RemovedExpectedQuery
  ...
  def handle_for_application(%{user_id: user_id}, command, %{user_id: user_id}) do
    ExpectedQuery.find(command.application_id, command.query_id)
