...
class Application extends React.Component {
    ...
    render() {
        ...
        return (
            <Confirm
                header="Remove Expected Query?"
                prompt="Are you sure you want to remove this expected query? Once removed, any other instances of this type of query will be reported as unexpected queries."
                positive="Remove"
                negative="Cancel"
                callback={this.removeExpectedQuery}
            >
                <button className={`ui icon button`} disabled={removing}>
                    {/* data-tooltip="Remove query from set of 'expected queries'." data-position="top right" */}
